...
class _HomeState extends State<Home> {
  ...
  @override
  void initState() {
    ShopProvider appProvider = Provider.of<ShopProvider>(context, listen: false);
                          ...
                          child: Column(
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: OutlinedButton(
                                  onPressed: () {
                                    Navigator.push(context, MaterialPageRoute(builder: (context)=>ItemDetails(product: singleProduct)));
                                  },
                                  child: const Text(
                                    "Buy",
                                  ),
